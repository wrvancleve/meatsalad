ClientEvents.lang('en_us', event => {
  ...
  event.add('allthemodium', 'item.allthemodium.alloy_axe', 'Palladium Alloy Axe')
  event.add('allthemodium', 'item.allthemodium.alloy_pick', 'Palladium Alloy Pick')
  event.add('allthemodium', 'item.allthemodium.alloy_sword', 'Palladium Alloy Blade')
  event.add('allthemodium', 'item.allthemodium.alloy_shovel', 'Palladium Alloy Shovel')
  event.add('allthemodium', 'item.allthemodium.alloy_paxel', 'Palladium Alloy Paxel')
  ...
  event.add('allthemodium', 'harvestTier.allthemodium.allthemodium', 'Palladium')
  event.add('allthemodium', 'harvestTier.allthemodium.vibranium', 'Vibranium')
