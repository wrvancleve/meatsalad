ItemEvents.tooltip(event => {
  ...
  event.add('industrialforegoing:laser_lens3', [
    Text.of('Prioritizes Diamond, Mythril, Platinum and Zinc in the Ore Laser Base').gold()
  ])
  ...
  event.add('industrialforegoing:laser_lens7', [
    Text.of('Prioritizes Silver in the Ore Laser Base').gold()
  ])
  ...
  event.add('industrialforegoing:laser_lens10', [
    Text.of('Prioritizes Azure Silver, Lead, Obsidian and Unobtainium in the Ore Laser Base').gold()
  ])
  ...
  event.add('industrialforegoing:laser_lens13', [
    Text.of('Prioritizes Peridot, Uranite and Vibranium in the Ore Laser Base').gold()
  ])
  ...
  event.add('industrialforegoing:laser_lens15', [
    Text.of('Prioritizes Bitumen and Coal in the Ore Laser Base').gold()
  ])
})
