StartupEvents.registry('item', event => {
  ...
  */
  ...
  const hasClassStage = (entity, stage) => {
    if (entity.level.isClientSide()) return true
    if (!entity.isPlayer()) return false
    if (entity.stages.has(stage)) return true
    entity.tell(Text.red(`You cannot equip this item! You must first unlock the ${global.getReadableText(stage)} from the skill tree!`))
    return false
  }
  ...
  createItem('arrow_damage_ring_plus', 'epic', true, 'Ring of Arrow Damage+')
    ...
    .attachCapability(CuriosCapabilityBuilder.CURIOS.itemStack()
      .canEquip((item, slotContext) => hasClassStage(slotContext.entity(), "archer_mastery_curios"))
  ...
  createItem('mana_ring_plus', 'epic', true, 'Ring of Mana+')
    ...
    .attachCapability(CuriosCapabilityBuilder.CURIOS.itemStack()
      .canEquip((item, slotContext) => hasClassStage(slotContext.entity(), "mage_mastery_curios"))
  ...
  createItem('attack_damage_ring_plus', 'epic', true, 'Ring of Attack Damage+')
    ...
    .attachCapability(CuriosCapabilityBuilder.CURIOS.itemStack()
      .canEquip((item, slotContext) => hasClassStage(slotContext.entity(), "warrior_mastery_curios"))
  ...
  createItem('armor_ring_plus', 'epic', true, 'Ring of Armor+')
    ...
    .attachCapability(CuriosCapabilityBuilder.CURIOS.itemStack()
      .canEquip((item, slotContext) => hasClassStage(slotContext.entity(), "guardian_mastery_curios"))
