ServerEvents.genericLootTables(event => {
  const LOOT_TABLES = [
    ...
    { id: "minecraft:chests/end_city_treasure", type: "random_chance" },
    { id: "minecraft:chests/stronghold_corridor", type: "random_chance" },
    { id: "minecraft:chests/stronghold_crossing", type: "random_chance" },
    { id: "allthemodium:chest/generic_loot", type: "random_chance" },
    { id: "allthemodium:chest/hallway_loot", type: "random_chance" },
    ...
    { id: "betterfortresses:chests/keep", type: "random_chance" },
